...
interface MoreFeaturesProps {
  content: SiteContent['moreFeatures'];
}
...
const FeatureCard: React.FC<{ feature: FeatureData }> = ({ feature }) => (
    ...
    <div className="mt-auto pt-6">
      <a href="#" className="group text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] transition-colors flex items-center justify-end font-semibold">
...
const MoreFeatures: React.FC<MoreFeaturesProps> = ({ content }) => {
  return (
