...
import type { RestaurantPage as RestaurantPageType } from '../siteData';
import {
    ClockIcon, InventoryIcon, CrmIcon, PosDeviceIcon, WarehouseManagementIcon,
    ProductionIcon, CustomerClubIcon, UserManagementIcon, DashboardIcon, ReceiptPrinterIcon,
    CreditCardTerminalIcon, SmsPanelIcon, ECommerceIcon, CheckCircleIcon,
    DesktopComputerIcon, RestaurantIcon, FinanceIcon, ReportsIcon, CalculatorIcon
} from './Icons';

const iconMap: { [key: string]: React.ElementType } = {
    ClockIcon, InventoryIcon, CrmIcon, WarehouseManagementIcon, PosDeviceIcon, ProductionIcon,
    CustomerClubIcon, UserManagementIcon, DashboardIcon, ReceiptPrinterIcon, CreditCardTerminalIcon,
    SmsPanelIcon, ECommerceIcon, CheckCircleIcon, DesktopComputerIcon, RestaurantIcon, FinanceIcon, ReportsIcon, CalculatorIcon
};


interface RestaurantPageProps {
  content: RestaurantPageType;
...
const RestaurantPage: React.FC<RestaurantPageProps> = ({ content, setView }) => {
          ...
          <Animated delay={200} className="flex flex-col gap-6">
            <nav aria-label="Breadcrumb">
              <ol className="flex items-center gap-1 text-sm text-[var(--color-text-secondary)]">
                ...
                <li><span className="opacity-50">/</span></li>
                <li className="font-medium text-[var(--color-text-primary)]" aria-current="page">نرم‌افزار رستورانی</li>
              </ol>
            </nav>
