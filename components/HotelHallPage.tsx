...
import type { HotelHallPage as HotelHallPageType } from '../siteData';
import {
    ClockIcon, CrmIcon, PosDeviceIcon, WarehouseManagementIcon,
    ProductionIcon, UserManagementIcon, DashboardIcon, CreditCardTerminalIcon, 
    SmsPanelIcon, ECommerceIcon, CheckCircleIcon,
    HotelIcon, ReportsIcon, CogIcon, FinanceIcon, RestaurantIcon
} from './Icons';

const iconMap: { [key: string]: React.ElementType } = {
    ClockIcon, CrmIcon, WarehouseManagementIcon, PosDeviceIcon, ProductionIcon,
    UserManagementIcon, DashboardIcon, CreditCardTerminalIcon,
    SmsPanelIcon, ECommerceIcon, CheckCircleIcon, HotelIcon, ReportsIcon, CogIcon, FinanceIcon, RestaurantIcon
};


interface HotelHallPageProps {
  content: HotelHallPageType;
...
const HotelHallPage: React.FC<HotelHallPageProps> = ({ content, setView }) => {
          ...
          <Animated delay={200} className="flex flex-col gap-6">
            <nav aria-label="Breadcrumb">
              <ol className="flex items-center gap-1 text-sm text-[var(--color-text-secondary)]">
                ...
                <li><span className="opacity-50">/</span></li>
                <li className="font-medium text-[var(--color-text-primary)]" aria-current="page">هتل و تالار</li>
              </ol>
            </nav>
